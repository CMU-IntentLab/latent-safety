...
from LCRL.policy.modelfree.ddpg_avoid_classical import avoid_DDPGPolicy_annealing as DDPGPolicy
...
class avoid_SACPolicy_annealing(DDPGPolicy):
    ...
    def train(self, mode: bool = True) -> "reach_avoid_game_SACPolicy_annealing":
        self.training = mode
