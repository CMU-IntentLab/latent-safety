...
from LCRL.utils import TensorboardLogger, WandbLogger
...
train_envs = DummyVectorEnv(
    [lambda: gymnasium.make(args.task_lcrl, params = [wm, expert_data]) for _ in range(args.training_num)]
)
test_envs = DummyVectorEnv(
    [lambda: gymnasium.make(args.task_lcrl, params = [wm, expert_data]) for _ in range(args.test_num)]
)
